module.exports = function mascotasHandler(mascotas){
    ...
    get: (data, callback) => {
      ...
      if (typeof data.indice !== "undefined") {
        ...
        return callback(404, {mensaje: "La Mascota con indice ${data.indice} no encontrada",});
      }
      if (
        data.query &&
    ...
    put: (data, callback) => {
      if (typeof data.indice !== "undefined") {
        ...
        return callback(404, {
          mensaje: `La maascota con indice ${data.indice} no encontrada`,
        });
      }
    ...
    delete: (data, callback) => {
      if (typeof data.indice !== "undefined") {
        ...
        return callback(404, {
          mensaje: "La mascota con indice ${data.indice} no encontrada",
        });
      }
      callback(400, { mensaje: "Indice no enviado" });
    },
